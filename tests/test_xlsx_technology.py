...
def test_helpers():
    ...
    assert _extract_hardness("Сталь 9ХС, HRC 48...52") == "HRC 48...52"
...
def test_build_technology_xlsx_fills_template():
    ...
    assert tk["D35"].value == "ИИ-ассистент"
    assert tk["J35"].value == "2026-08-11"
...
def test_build_technology_xlsx_overflow_extra_sheet():
    ...
    # при большом маршруте появляются доп. листы ТК
